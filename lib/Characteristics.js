(function(){
  var React, Component, DOM, div, span, button, cx, Characteristic, STR, DEX, POW, CON, APP, EDU, SIZ, INT, Characteristics;
  ...
  Characteristics = (function(superclass){
    ...
    prototype.render = function(){
      var ref$, str, con, pow, dex, app, edu, siz, int, this$ = this;
