(function(){
  ...
  App = (function(superclass){
    ...
    prototype.render = function(){
      var ref$, characteristics, notify;
      ref$ = this.props, characteristics = ref$.characteristics, notify = ref$.notify;
      return Characteristics((characteristics.notify = notify, characteristics));
    };
    return App;
  }(Component));
  module.exports = App;
